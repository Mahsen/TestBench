...
#include "misc.h"
//----------------------------------------------------------
#define SYSTEM_APPLICATION_PROGRAM_ADDRESS_JUMP	  0x08008000
//----------------------------------------------------------
...
void SystemInit (void)
{
	...
	RCC_SYSCLKConfig(RCC_SYSCLKSource_PLLCLK);// => 32 Mhz
	RCC_HCLKConfig(RCC_SYSCLK_Div1);// => 32 Mhz
	RCC_PCLK1Config(RCC_HCLK_Div2);// => 16 Mhz
	RCC_PCLK2Config(RCC_HCLK_Div2);// => 16 Mhz
